...
<header>
    ...
    <p>"Temukan ragam masakan dari berbagai belahan dunia, mulai dari masakan lokal hingga internasional yang menggugah selera."</p>
</header>
...
<div class="container">
            <div class="row">
                ...
                $sql = "SELECT * FROM jenis_masakan WHERE id_jenis = '$id_jenis'";
                ...
                ?>
                <h2>Resep masakan berdasarkan jenis "<?php echo $nama_jenis;?>"</h2>
                <?php } ?>
                <br><br>
                    <div class="row">
                    ...
                    $id_jenis_terpilih = $_GET['id_jenis'];
                    $sql = "SELECT kontributor.id_kontributor, resep.nama_resep, resep.bahan, resep.langkah, resep.gambar, resep.deskripsi, pedas.tingkat_pedas, teknik_masak.teknik, jenis_masakan.jenis, teknik_masak.id_teknik, pedas.id_pedas, jenis_masakan.id_jenis
                            ...
                            WHERE kontributor.id_jenis = '$id_jenis_terpilih'
