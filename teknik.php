...
<header>
    ...
    <p>"Jelajahi resep-resep yang memanfaatkan teknik memasak khusus, seperti panggang, tumis, rebus, dan lainnya untuk hasil masakan yang lezat."</p>
</header>
...
<div class="container">
            <div class="row">
                ...
                <div class="col-lg-8">
                <?php 
                $id_teknik = $_GET['id_teknik'];
                $sql = "SELECT * FROM teknik_masak WHERE id_teknik = '$id_teknik'";
                $result = $conn->query($sql);

                if ($result->num_rows > 0) {
                // output data of each row
                while($row = $result->fetch_assoc()) {
                    $nama_teknik = $row['teknik'];
                }
                ?>
                <h2>Resep masakan berdasarkan teknik "<?php echo $nama_teknik;?>"</h2>
                <?php } ?>
                <br><br>
                    <div class="row">
                    ...
                    $id_teknik_terpilih = $_GET['id_teknik'];
                    $sql = "SELECT kontributor.id_kontributor, resep.nama_resep, resep.bahan, resep.langkah, resep.gambar, resep.deskripsi, pedas.tingkat_pedas, teknik_masak.teknik, jenis_masakan.jenis, teknik_masak.id_teknik, pedas.id_pedas, jenis_masakan.id_jenis
                            ...
                            WHERE kontributor.id_teknik = '$id_teknik_terpilih'
