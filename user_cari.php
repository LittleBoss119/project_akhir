...
<div class="container">
            <div class="row">
                <!-- Blog entries-->
                <div class="col-lg-8">
                <h2 class="mb-4">Cek Resep Terbaru !</h2> <!-- Teks judul atau informasi -->
                <h2 class="mb-4"></h2> <!-- Teks judul atau informasi -->
                    <!-- Featured blog post-->                  
                    <?php
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <a class="btn btn-primary" href="user_resep.php?id_kontributor=<?php echo $data_id_kontributor; ?>&id_jenis=<?php echo $data_id_jenis;?>&id_teknik=<?php echo $data_id_teknik;?>&id_pedas=<?php echo $data_id_pedas;?>">Lihat →</a>
                        </div>
                    </div>
                    <?php
                            }
                    ...
                    <div class="row">
                    <h4 class="mb-4">Temukan resep sesuai selera !</h4>
                    <?php
                    
                    $sql_post = "SELECT kontributor.id_kontributor, resep.nama_resep, resep.bahan, resep.langkah, resep.gambar, pedas.tingkat_pedas, teknik_masak.teknik, jenis_masakan.jenis, teknik_masak.id_teknik, pedas.id_pedas, jenis_masakan.id_jenis
                            FROM kontributor 
                            JOIN resep ON kontributor.id_resep = resep.id_resep 
                            JOIN pedas ON kontributor.id_pedas = pedas.id_pedas 
                            JOIN teknik_masak ON kontributor.id_teknik = teknik_masak.id_teknik 
